...
export default {
  ...
  dashboard: {
    ...
    top_partners: "Frequent split partners",
    top_partners_empty: "No shared expenses yet",
    top_partners_hint: "Create a group or add friends to existing ones",
    all_contacts: "All contacts",
    joint_expenses_count: "{{count}}",
	joint_expenses_label: "Shared expenses",
    most_spent_category: "Most spent in category",

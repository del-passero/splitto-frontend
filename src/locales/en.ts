export default {
  ...
  // --- Transactions ---
  group_transactions_empty: "There are no transactions in this group yet — add the first one!",
  ...
  invite_message: "Join me in Splitto — an easy way to manage shared expenses right in Telegram.\nHere's your link:\n{{link}}",

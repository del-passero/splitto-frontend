...
export default {
  ...
  invite_message:
    "Join me on Splitto Ч an easy way to manage shared expenses right in Telegram.\nHere is your link:\n{{link}}",
  invite_group_message:
    "Join the group У{{group}}Ф on Splitto Ч a convenient way to track shared expenses.\nHere is your link to join:\n{{link}}",
  ...
  group_form: {
    ...
    avatar_uploaded: "Image uploaded Ч don't forget to save",
  ...
  group_modals: {
    ...
    delete_soft_confirm:
      "The group will be deleted. If there are transactions Ч it can be restored. If there are no transactions Ч it will be deleted permanently. Continue?",
  ...
  tx_modal: {
	...
	receipt_photo_label: "‘ото\nчека",
	receipt_photo_alt: "‘ото чека",
	receipt_not_attached: "„ек не прикреплЄн",
	receipt_attached_pdf: "ѕрикреплЄн PDF",
	receipt_attached_image: "ѕрикреплено изображение",
	receipt_open_preview: "ќткрыть предпросмотр",
	receipt_attach: "ѕрикрепить чек",
	receipt_replace: "«аменить",
	receipt_remove: "”далить",
  ...
  invite_page: {
    ...
    loading_preview: "Loading inviteЕ",
    close_aria: "Close",
  },

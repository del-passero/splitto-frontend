...
export default {
  ...
  // Унифицированные тексты модалок по действиям с группой
  group_modals: {
    // смарт-подтверждения
    archive_confirm: "Вы хотите переместить группу в архив?",
    unarchive_confirm: "Вы хотите восстановить группу из архива?",
    delete_forbidden_debts: "В группе есть долги, по которым не рассчитались, эту группу нельзя удалить",
    delete_soft_confirm: "Группа будет удалена, так-как в группе есть транзакции её можно будет восстановить",
    delete_hard_confirm: "Группа будет удалена безвозвратно, Вы уверены?",
    restore_confirm: "Вы хотите восстановить удаленную группу?",
    archive_forbidden_debts: "В группе есть долги, по которым не рассчитались, эту группу нельзя переместить в архив",
    // запрет редактирования
    edit_blocked_deleted: "Группа удалена. Её нельзя редактировать — сперва восстановите группу.",
    edit_blocked_archived: "Группа в архиве. Её нельзя редактировать — сперва переместите её из архива.",
  },

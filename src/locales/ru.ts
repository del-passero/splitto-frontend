...
export default {
  ...
  dashboard: {
	...
	top_partners_empty: "Пока нет совместных расходов",
	top_partners_hint: "Создайте группу или добавьте друзей в существующие",
	all_contacts: "Все контакты",
	joint_expenses_count: "{{count}}",
	joint_expenses_label: "Совместных расходов",
    most_spent_category: "Чаще всего тратили в категории",

...
export default {
  /* =============================
   * Навигация / разделы верхнего уровня
   * ============================= */
  main: "Главная",
  groups: "Группы",
  group: "Группа",
  ...
  /* =============================
   * Даты / Последняя активность / Форматы
   * ============================= */
  ...
  /* =============================
   * Общие структуры (да/нет), валюты, категории
   * ============================= */
  ...
  /* =============================
   * Группы — список, карточка, участники, статусы
   * ============================= */
  ...
  /* =============================
   * Страница группы — FAB и быстрые действия
   * ============================= */
  ...
  /* Короткие подписи / пустые состояния */
  i_owe: "Я должен",
  ...
  /* Кнопки раскрыть/свернуть список */
  expand_all: "Развернуть все",     // (с опечаткой — оставлено для совместимости)
  collapse_all: "Свернуть все",

  /* Кнопки внутри карточек долгов */
  ...
  /* =============================
   * Ограничения на действия (общие предупреждения)
   * ============================= */

...
export default {
  ...
  // --- Доп. статусы/маркеры для карточек ---
  hidden: "Скрыта",

  // --- Модалки действий с группой (локализация текстов предупреждений) ---
  group_modals: {
    archive_confirm: "Вы хотите переместить группу в архив?",
    archive_forbidden_debts:
      "В группе есть долги, по которым не рассчитались, эту группу нельзя переместить в архив",
    unarchive_confirm: "Вы хотите восстановить группу из архива?",
    delete_forbidden_debts:
      "В группе есть долги, по которым не рассчитались, эту группу нельзя удалить",
    delete_soft_confirm:
      "Группа будет удалена, так-как в группе есть транзакции, её можно будет восстановить",
    delete_hard_confirm:
      "Группа будет удалена безвозвратно, Вы уверены?",

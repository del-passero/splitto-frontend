...
export default {
  ...
  group_not_found: "Группа не найдена",            // ← добавлено
  ...
  // Модалки действий над группой
  group_modals: {
    // Archive / Unarchive
    archive_confirm: "Вы хотите переместить группу в архив?",
    unarchive_confirm: "Вы хотите восстановить группу из архива?",
    // Delete (единая кнопка — бэкенд решит soft/hard)
    delete_soft_confirm: "Группа будет удалена. Если в группе есть транзакции — её можно будет восстановить. Если нет транзакций — удалим безвозвратно. Продолжить?",
    // Restore
    ...
    edit_blocked_archived: "Группа в архиве, её нельзя редактировать. Сперва переместите группу из архива.",
  },

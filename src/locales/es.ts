...
export default {
  ...
  period: {
    ...
    week_prev: "la semana pasada",
    weeks_ago_2: "hace 2 semanas",
    weeks_ago_3: "hace 3 semanas",
  },
  dashboard: {
    activity: "Actividad de gasto",
    top_categories_title: "Categorías principales",
    ...
    top_partners: "Compañeros frecuentes",
    top_partners_empty: "Aún no hay gastos compartidos",
    top_partners_hint: "Crea un grupo o añade amigos a los existentes",
    all_contacts: "Todos los contactos",
    joint_expenses_count: "{{count}}",
	joint_expenses_label: "Gastos compartidos: ",
    most_spent_category: "Categoría con más gasto",

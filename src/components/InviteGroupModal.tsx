// src/components/InviteGroupModal.tsx
...
/**
 * Модалка для генерации и копирования инвайт-ссылки для группы.
 * - Генерирует invite-link через backend
 * - Кнопка "Скопировать", "Поделиться" (если поддерживается)
 */

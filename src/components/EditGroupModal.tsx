 ...
 * - Позволяет редактировать название, описание
 * - Добавлять новых участников из друзей (без удаления)
 * - Показывает владельца (создателя) с короной 👑
 * - Валидация, лоадер, обработка ошибок
 */
          ...
          >
            <div className="inline-block align-bottom bg-[var(--tg-card-bg)] rounded-2xl px-5 py-6 text-left shadow-xl w-full max-w-md transition-all">
              ...
              <div className="mb-4">
                ...
                {/* Добавить новых участников из друзей */}
